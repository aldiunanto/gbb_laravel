						...
						<table class="data-list">
							...
							<tbody>
								<tr>
									...
									<td class="sat-jum text-center">&nbsp;</td>
									<td class="sat-jum text-center">&nbsp;</td>
									<td class="sat-jum text-center">&nbsp;</td>
									<td class="sat-jum text-center"><input type="text" name="pengels_permintaan[]" class="text-center" /></td>
									<td class="sat-jum text-center"><input type="text" name="pengels_realisasi[]" class="text-center" /></td>
									<td class="sat-jum text-center"><input type="text" name="pengels_ket[]" class="text-center" /></td>
