...
class Retur_penerimaan_sub extends Model {
	...
	public static function fetch($returpener_id, $pener_id = null){
		$i 		= new static;
		$get 	= self::select('E.mat_nama', 'E.mat_spesifikasi', 'F.wrn_nama', 'G.mats_nama', 'B.peners_jml', $i->table.'.returpeners_jml', $i->table.'.returpeners_reason', 'H.returpener_status')
