...
class Penerimaan_sub extends Model {
	...
	public static function fetchDetail($where = null){
		$i 		= new static;
		$query	= self::select('B.pener_id', 'B.pener_date', 'B.created_at', $i->table.'.peners_jml', 'E.pbs_jml', 'D.po_no', 'F.mat_id', 'F.mat_nama', 'F.mat_spesifikasi', 'G.mats_nama')
		...
		/*SELECT B.pener_id, B.pener_date, B.created_at, A.peners_jml, E.pbs_jml, D.po_id, D.po_no, F.mat_id, F.mat_nama, F.mat_spesifikasi
